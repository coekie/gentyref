...
public abstract class AbstractGenericsReflectorTest {
  ...
  private static final TypeToken<ArrayList<String>> ARRAYLIST_OF_STRING =
      new TypeToken<ArrayList<String>>() {};
  private static final TypeToken<List<String>> LIST_OF_STRING = new TypeToken<List<String>>() {};
  private static final TypeToken<Collection<String>> COLLECTION_OF_STRING =
      new TypeToken<Collection<String>>() {};

  private static final TypeToken<ArrayList<List<String>>> ARRAYLIST_OF_LIST_OF_STRING =
      new TypeToken<ArrayList<List<String>>>() {};
  private static final TypeToken<List<List<String>>> LIST_OF_LIST_OF_STRING =
      new TypeToken<List<List<String>>>() {};
  private static final TypeToken<Collection<List<String>>> COLLECTION_OF_LIST_OF_STRING =
      new TypeToken<Collection<List<String>>>() {};

  private static final TypeToken<ArrayList<? extends String>> ARRAYLIST_OF_EXT_STRING =
      new TypeToken<ArrayList<? extends String>>() {};
  private static final TypeToken<Collection<? extends String>> COLLECTION_OF_EXT_STRING =
      new TypeToken<Collection<? extends String>>() {};

  private static final TypeToken<Collection<? super String>> COLLECTION_OF_SUPER_STRING =
      new TypeToken<Collection<? super String>>() {};

  private static final TypeToken<ArrayList<List<? extends String>>>
      ARRAYLIST_OF_LIST_OF_EXT_STRING = new TypeToken<ArrayList<List<? extends String>>>() {};
  private static final TypeToken<List<List<? extends String>>> LIST_OF_LIST_OF_EXT_STRING =
      new TypeToken<List<List<? extends String>>>() {};
  private static final TypeToken<Collection<List<? extends String>>>
      COLLECTION_OF_LIST_OF_EXT_STRING = new TypeToken<Collection<List<? extends String>>>() {};
  ...
  private <T> void checkedTestInexactSupertype(
      TypeToken<T> expectedSuperclass, TypeToken<? extends T> type) {
    testInexactSupertype(expectedSuperclass, type);
  }

  /**
   * Checks if the supertype is seen as a supertype of subType. But, if superType is a Class or
   * ParameterizedType, with different type parameters.
   */
   ...
   * can be applied
   */
  private <T> void checkedTestExactSuperclass(
      TypeToken<T> expectedSuperclass, TypeToken<? extends T> type) {
  ...
  /**
   * Checks if the supertype is seen as a supertype of subType. SuperType must be a Class or
   * ParameterizedType, with the right type parameters.
   */
  ...
  protected static Class<?> getClassType(Type type) {
    if (type instanceof Class) {
      ...
      throw new IllegalArgumentException(
          "Only supports Class, ParameterizedType and GenericArrayType. Not " + type.getClass());
    }
  }
  ...
  /**
   * Marker interface to mark the type of the field f. Note: we could use a method instead of a
   * field, so the method could be in the interface, enforcing correct usage, but that would
   * influence the actual test too much.
   */
  interface WithF<T> {}

  /** Variant on WithF, where the type parameter is a TypeToken. TODO do we really need this? */
  interface WithFToken<T extends TypeToken<?>> {}

  /**
   * Uses the reflector being tested to get the type of the field named "f" in the given type. The
   * returned value is cased into a TypeToken assuming the WithF interface is used correctly, and
   * the reflector returned the correct result.
   */
  ...
  private <T, U extends T> void checkedTestExactSuperclassChain(
  ...
  private <T, U extends T> void checkedTestInexactSupertypeChain(
      TypeToken<T> type1, TypeToken<U> type2, TypeToken<? extends U> type3) {
  ...
  /**
   * Dummy method to force the compiler to see the reference to the given local class. Workaround
   * for Issue 15 (http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=7003595)
   */
  ...
  public void testListOfListOfT_String() {
    checkedTestExactSuperclassChain(
        ...
        new TypeToken<ListOfListOfT<String>>() {});
  }
  ...
  public void testUExtendsListOfExtT() {
    ...
    // this doesn't compile in eclipse nor with sun compiler, so we hold the compilers hand by
    // adding some steps in between
    // TypeToken<? extends List<? extends String>> ft =
  ...
  public void testInnerFieldWithTypeOfOuter() {
    ...
    TypeToken<List<List<? extends String>>> ft2 =
        getStrictF(new TypeToken<Outer<String>.Inner2>() {});
  ...
  public void testInnerDifferentParams() {
    ...
    testNotSupertypes(
        new TypeToken<Outer<String>.Inner<Integer>>() {},
        new TypeToken<Outer<String>.Inner<String>>() {});
    // outer param different
    testNotSupertypes(
        new TypeToken<Outer<Integer>.Inner<String>>() {},
        new TypeToken<Outer<String>.Inner<String>>() {});
  }
  ...
  public void testSuperWildcard() {
    ...
    testInexactSupertype(
        getFieldType(new TypeToken<Box<? super Integer>>() {}, "f"), tt(Integer.class));
  ...
  public void testGenericArrays() {
    ...
    checkedTestInexactSupertype(
        new TypeToken<Collection<? extends Number>[]>() {},
  ...
  public void testCaptureContainmentViaOtherParam() {
    ...
    c1 = c2;
    c2 = c1;
    testMutualSupertypes(
        new TypeToken<C<? extends Number, ? extends List<? extends Number>>>() {},
