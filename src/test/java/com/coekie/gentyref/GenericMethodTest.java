...
public class GenericMethodTest extends TestCase {
  ...
  public void testSimpleGenericMethodUnresolvedReturnType()
    ...
    assertTrue(
        Arrays.equals(
            new Type[] {String.class}, GenericTypeReflector.getExactParameterTypes(m, C.class)));
  ...
  /**
   * Returns a class nested in this method that contains a method "m" who's return type is this
   * method's type variable E.
   */
  public <E> Class<?> returnsTypeVariableFromOuterMethod()
      throws SecurityException, NoSuchMethodException {
    class C {
      @SuppressWarnings("unused")
      public E m() {
  ...
  public void testReturnsTypeVariableFromOuterMethod()
    ...
    TypeVariable<?> e =
        GenericMethodTest.class.getMethod("returnsTypeVariableFromOuterMethod")
            .getTypeParameters()[0];
  ...
  public <E> Class<?> extendsWithTypeVariableFromOuterMethod()
      throws SecurityException, NoSuchMethodException {
  ...
  public void testExtendsWithTypeVariableFromOuterMethod()
    ...
    TypeVariable<?> e =
        GenericMethodTest.class.getMethod("extendsWithTypeVariableFromOuterMethod")
            .getTypeParameters()[0];
  ...
  /**
   * Test when a type containing a type variable from an unrelated method is given. This is
  ...
  public void testTypeVariableFromMethodGiven() throws SecurityException, NoSuchMethodException {
    ...
    TypeVariable<?> e =
        GenericMethodTest.class.getMethod("typeVariableFromMethod").getTypeParameters()[0];
