...
public class ToStringTest {
    ...
    public void parameterizedTypeTest() {
        ...
        assertEquals("@com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123) " +
                "java.util.List<@com.coekie.gentyref.ToStringTest$A2(meta=Meta Data, " +
                "target=@com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123)) java.lang.String>", type.toString());
    }
    ...
    public void innerTypeTest() {
        ...
        assertEquals("@com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123) " +
                "com.coekie.gentyref.ToStringTest.Inner<@com.coekie.gentyref.ToStringTest$A2" +
                "(meta=Meta Data, target=@com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123)) java.lang.String>", type.toString());
    }
    ...
    public void arrayTypeTest() {
        ...
        assertEquals("@com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123) " +
                "java.lang.String @com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123) []", arrayType.toString());
    }
    ...
    public void variableTypeTest() {
        ...
        assertEquals("@com.coekie.gentyref.Annotations$A3() " +
                "T extends java.lang.Number, @com.coekie.gentyref.Annotations$A4() java.io.Serializable", type.toString());
    }
    ...
    public void wildcardTypeTest() throws NoSuchMethodException {
        ...
        assertEquals("? extends @com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123) java.lang.Number", type.toString());
        ...
        assertEquals("? super @com.coekie.gentyref.ToStringTest$A1(key=Magic Key, value=123) java.lang.Number", type.toString());
    }
