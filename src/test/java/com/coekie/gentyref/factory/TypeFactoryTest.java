...
import static com.coekie.gentyref.TypeFactory.innerClass;
import static com.coekie.gentyref.TypeFactory.parameterizedClass;
import static com.coekie.gentyref.TypeFactory.parameterizedInnerClass;
...
import com.coekie.gentyref.factory.GenericOuter.DoubleGeneric;
import com.coekie.gentyref.factory.GenericOuter.Inner;
...
public class TypeFactoryTest extends TestCase {
  ...
  public void testConcreteRawOuterGenericInner() {
    ...
    // TODO what does the GenericTypeReflector.getExactReturnType do for a method in RawOuter that
  ...
  public void testStaticInnerWithoutOwner() {
    ...
    assertEquals(
        GenericOuter.class,
        ((ParameterizedType) new TypeToken<GenericOuter.StaticGenericInner<Integer>>() {}.getType())
            .getOwnerType());
  ...
  public void testStaticInnerWithRawSubclassOwner() {
    assertEquals(
        new TypeToken<GenericOuter.StaticGenericInner<Integer>>() {}.getType(),
        parameterizedInnerClass(
            RawOuter.class, GenericOuter.StaticGenericInner.class, Integer.class));
  ...
  public void testStaticInnerWithGenericOwner() {
    Type result =
        parameterizedInnerClass(
            GENERICOUTER_STRING, GenericOuter.StaticGenericInner.class, Integer.class);
  ...
  // TODO what if the specified owner type is a wildcard, a capture, a (generic) array or a type
  // variable,...
  ...
  public void testTypeArgumentsNotInReferingBound() {
    try {
      parameterizedClass(
          ReferingBound.class, parameterizedClass(List.class, Integer.class), Number.class);
      fail("expected exception");
    } catch (IllegalArgumentException expected) {
    }
  }
  ...
  public void testRawTypeArgumentInRawBound() {
    assertEquals(
        new TypeToken<RawBound<ArrayList>>() {}.getType(),
  ...
  public void testLocalClass() {
    ...
    assertEquals(
        new TypeToken<Local<String>>() {}.getType(), parameterizedClass(Local.class, String.class));
  }
