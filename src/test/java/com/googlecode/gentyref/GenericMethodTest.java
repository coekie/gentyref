...
public class GenericMethodTest extends TestCase {
	...
	/**
	 * Test if UnresolvedTypeVariableException is thrown if there is an unresolved type parameter coming from
	 * a simple generic method in a parameter.
	 */
	...
	/**
	 * Test if UnresolvedTypeVariableException is thrown if there is an unresolved type parameter coming from
	 * a simple generic method in a return type
	 */
	...
	/**
	 * Test if UnresolvedTypeVariableException is thrown if there is an unresolved type parameter coming from
	 * a simple generic method, deep in the return type, nested in a generic array and wildcards
	 */
